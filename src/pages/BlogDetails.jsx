    ...
    return (
        <Box sx={{width:'100%', maxWidth:'1500px', margin:'auto', px:{xs:'15px', md:'25px'}, pt:{xs:'120px', md:'180px'}, pb:{xs:'20px', md:'40px'}}}>
            <Box data-aos="fade-right" sx={{display:'flex', alignItems:'center', gap:'8px', mb:'20px', flexWrap:'wrap'}}>
                ...
                <Typography component={Link} to="/blog" sx={{textDecoration:'none', color:'rgba(68,107,128,0.6)', fontSize:'14px'}}>Блог</Typography>
                <Typography sx={{color:'rgba(68,107,128,0.6)', fontSize:'14px'}}>›</Typography>
                <Typography sx={{color:'#446B80', fontSize:'14px', fontWeight:500, maxWidth:{xs:'220px', md:'none'}, whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis'}}>{article.title}</Typography>
            </Box>
            ...
            <Box data-aos="zoom-in" sx={{maxWidth:'920px', margin:'auto', height:{xs:'240px', sm:'400px', md:'550px'}, borderRadius:'20px', overflow:'hidden', mb:{xs:'24px', md:'40px'}}}>
                <Box component="img" src={article.image} alt={article.title} sx={{width:'100%', height:'100%', objectFit:'cover', display:'block'}} />
            </Box>
            ...
            <Box sx={{maxWidth:'920px', margin:'auto'}}>
                ...
                {defaultArticleContent.paragraphs.map((text, i) => (
                ...
                <Box data-aos="fade-up" sx={{width:'100%', height:{xs:'220px', sm:'350px', md:'450px'}, borderRadius:'16px', overflow:'hidden', my:{xs:'25px', md:'35px'}}}>
                    <Box component="img" src={article.contentImg} alt={article.title} sx={{width:'100%', height:'100%', objectFit:'cover', display:'block'}} />
                </Box>
